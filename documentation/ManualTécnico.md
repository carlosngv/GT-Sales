...
El modelo que se utilizó para realizar la base de datos es el siguiente:

![Main](../oracle-scripts-model/Modelo.png)
...
![NewProduct](./screenshots/new-product.png)
...
![NewPurchase](./screenshots/newPurchase.png)
...
![ShoppingChart](./screenshots/shopping-cart.png)
...
![AndroidStudio](./screenshots/android-studio.png)
